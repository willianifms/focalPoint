...
function DeletarTarefa({ onConfirmDelete }) {
  return (
    <Popup
      trigger={
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const tarefasCorretas = tarefasSalvas.map((tarefa) => ({
      ...tarefa,
      completed: tarefa.completed || false, // Garantir que 'completed' está definido
    }));
    setTarefas(tarefasCorretas);
  }, []);
